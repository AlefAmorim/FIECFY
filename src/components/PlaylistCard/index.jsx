...
function PlaylistCard({title, description, imgUrl}) {
    return (
        <div className="group card  relative flex flex-col w-45  p-3 items-center    text-white rounded-lg cursor-pointer hover:bg-zinc-700/20 hover:scale-102  transition-colors">
