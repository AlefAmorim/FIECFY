...
// function Player() {
//     return (
//         <footer className="bg-linear-to-l from-zinc-950/70 to-zinc-950/70 /*fixed*/  backdrop-blur-md  p-5  grid grid-cols-2  grid-rows-[90%_10%] lg:grid-cols-[40%_1fr_40%] xl:grid-rows-1 w-screen h-30  /*bottom-0*/ gap-2">
